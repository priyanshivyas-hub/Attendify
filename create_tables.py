...
# Professors (all from your seed data)
professors = [
...
# ALL 60 Students (from your original seed data)
students = [
    ('en24it3010061@medicaps.ac.in', 'KUSH GANGRADE'),
    ('en24it3010062@medicaps.ac.in', 'KUSHAL PATHAK'),
    ('en24it3010063@medicaps.ac.in', 'LAKSHYADITYA KARDAM'),
    ('en24it3010064@medicaps.ac.in', 'MAANYA WALEKAR'),
    ('en24it3010065@medicaps.ac.in', 'MANASVI CHOUHAN'),
    ('en24it3010066@medicaps.ac.in', 'MANSI MUKATI'),
    ('en24it3010067@medicaps.ac.in', 'MAYUR PATEL'),
    ('en24it3010068@medicaps.ac.in', 'MOAYAN FOUJDAR'),
    ('en24it3010069@medicaps.ac.in', 'MOUSAM NAGAR'),
    ('en24it3010070@medicaps.ac.in', 'MUSKAN MALAKAR'),
    ('en24it3010071@medicaps.ac.in', 'NAVNEET SINGH RAJPUT'),
    ('en24it3010072@medicaps.ac.in', 'NISHTHA DHINGRA'),
    ('en24it3010073@medicaps.ac.in', 'NISHTHA SONI'),
    ('en24it3010074@medicaps.ac.in', 'OJAS PATIDAR'),
    ('en24it3010077@medicaps.ac.in', 'PIYUSH JANGID'),
    ('en24it3010078@medicaps.ac.in', 'PRAMUKH KUMBHKAR'),
    ('en24it3010079@medicaps.ac.in', 'PRANJAL SHARMA'),
    ('en24it3010081@medicaps.ac.in', 'PRAVIN CHOUHAN'),
    ('en24it3010082@medicaps.ac.in', 'PREYASI SHRIVASTAVA'),
    ('en24it3010083@medicaps.ac.in', 'PRIYANKA BINTHARIYA'),
    ('en24it3010084@medicaps.ac.in', 'PRIYANSH VERMA'),
    ('en24it3010085@medicaps.ac.in', 'PRIYANSHI MAHESHWARI'),
    ('en24it3010086@medicaps.ac.in', 'PRIYANSHI VYAS'),
    ('en24it3010087@medicaps.ac.in', 'PRIYANSHU JAISWAL'),
    ('en24it3010088@medicaps.ac.in', 'PRIYANSHU RAJPUT'),
    ('en24it3010089@medicaps.ac.in', 'RADHIKA PALOD'),
    ('en24it3010090@medicaps.ac.in', 'RAJNANDINI TOMAR'),
    ('en24it3010091@medicaps.ac.in', 'RAM'),
    ('en24it3010093@medicaps.ac.in', 'RIDIMA SONER'),
    ('en24it3010094@medicaps.ac.in', 'RISHIKA RATHOD'),
    ('en24it3010095@medicaps.ac.in', 'RITIK POUNEKAR'),
    ('en24it3010096@medicaps.ac.in', 'ROHAN KALYANE'),
    ('en24it3010097@medicaps.ac.in', 'RUCHI CHATURVEDI'),
    ('en24it3010099@medicaps.ac.in', 'SAMARTH MAURYA'),
    ('en24it3010100@medicaps.ac.in', 'SAMARTH SINGH SISODIYA'),
    ('en24it3010101@medicaps.ac.in', 'SAUMYA AGRAWAL'),
    ('en24it3010102@medicaps.ac.in', 'SHABBIR EZZY'),
    ('en24it3010103@medicaps.ac.in', 'SHAHEER AHMED CHOUDHARY'),
    ('en24it3010104@medicaps.ac.in', 'SHAILY PATIDAR'),
    ('en24it3010105@medicaps.ac.in', 'SHAURYA JAIN'),
    ('en24it3010106@medicaps.ac.in', 'SHREYA REDDY'),
    ('en24it3010107@medicaps.ac.in', 'SIDDHANT KAURAV'),
    ('en24it3010108@medicaps.ac.in', 'SOMIL JAIN'),
    ('en24it3010109@medicaps.ac.in', 'SOMYA KUSHWAH'),
    ('en24it3010110@medicaps.ac.in', 'SONALI KELWA'),
    ('en24it3010111@medicaps.ac.in', 'TANISHA RATHORE'),
    ('en24it3010112@medicaps.ac.in', 'TUSHAR LAAD'),
    ('en24it3010113@medicaps.ac.in', 'UKE REVATI KAILAS'),
    ('en24it3010114@medicaps.ac.in', 'VAIBHAV KUMAR SINGH'),
    ('en24it3010115@medicaps.ac.in', 'VAISHANVI SINGH'),
    ('en24it3010116@medicaps.ac.in', 'VANDANA KUMARI'),
    ('en24it3010117@medicaps.ac.in', 'VANSHIKA KATHAL'),
    ('en24it3010118@medicaps.ac.in', 'VANSHIKA YADAV'),
    ('en24it3010119@medicaps.ac.in', 'VIRENDRA SINGH KAMDAR'),
    ('en24it3010120@medicaps.ac.in', 'YUVRAJ SINGH BAGHEL'),
    ('en24me3040040@medicaps.ac.in', 'KHANAK SONONE'),
    ('en24me3040041@medicaps.ac.in', 'KHUSH PATIDAR'),
    ('en24me3040051@medicaps.ac.in', 'MAYANK SHARMA'),
    ('en24me3040111@medicaps.ac.in', 'YOGITA KUMAVAT'),
...
print(f"✅ Users added: 1 admin + {len(professors)} professors + {len(students)} students = {1+len(professors)+len(students)} total")
...
# ==================== ENROLLMENTS (ALL 60 students × 7 courses = 420) ====================
...
# ==================== CLASS INSTANCES (Last 30 days + Next 30 days) ====================
...
# ==================== ATTENDANCE (Dummy for past classes) ====================
...
cursor.execute("SELECT user_id, full_name FROM users WHERE role='student' LIMIT 60")
...
for prof in all_professors:
    for stu in all_students[:3]:  # Each professor chats with 3 students
...
print(f"✅ Messages added: {msg_count}")

# ==================== PROFESSOR LOCATIONS ====================
statuses = ['Free', 'In Class', 'Busy', 'Available Soon', 'In Meeting']
...
print("="*60)
print("Login: admin@medicaps.ac.in / password123")
print("Student: en24it3010086@medicaps.ac.in / password123")
print("Prof: sagar.pandya@medicaps.ac.in / password123")
print("="*60)